...
Fig.MRI.Labels      = {'Anatomical','Resolution (mm)','Dimensions (voxels)','Origin (voxels)','Permute','Save volume', 'Load mesh', 'Contrast'};
Fig.MRI.Style       = {'pushbutton','edit','edit','edit','pushbutton','pushbutton','pushbutton','pushbutton'};
Fig.MRI.List        = {nii.filename, nii.VoxDim, nii.DimVox, nii.OriginVox, 'Permute', 'Save', 'Mesh file', 'Contrast'};
